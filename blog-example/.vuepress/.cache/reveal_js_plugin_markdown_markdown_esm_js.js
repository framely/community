...
var Qf = function() {
  function e2(n2) {
    t(this, e2), this.tokens = [], this.tokens.links = Object.create(null), this.options = n2 || df, this.options.tokenizer = this.options.tokenizer || new Uf(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = { inLink: false, inRawBlock: false, top: true };
