...
var Go = function() {
  function t2(e2) {
    ur(this, t2), this.tokens = [], this.tokens.links = Object.create(null), this.options = e2 || ko, this.options.tokenizer = this.options.tokenizer || new Wo(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = { inLink: false, inRawBlock: false, top: true };
