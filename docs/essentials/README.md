...
The objective of CUI is thus to instantiate some function type or create an instance of that function through conversations. This involves identifying the function by its name and recursively creating instances for all its input parameters at a language-independent schema level from natural language conversations. 
