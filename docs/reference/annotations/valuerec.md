...
```json
User: "Get me two tickets for Star Wars for tonight, please."
Chatbot: "What time? For Star Wars, we only have two showings left at 19:30pm and 21:30pm. Which one do you want?"
```
...
```json
User: "Get me two tickets for Star Wars for tonight, please."
Chatbot: "Ok, what time?"
User: "18:30pm"
Chatbot: "Sorry, Star Wars at 18:30pm have sold out, please choose another time."
User: "19:00pm"
Chatbot: "Sorry, Star Wars at 19:00pm have sold out, please choose another time."
```
...
```json
Chatbot: "Which color do you want on the tempo next percent? We only have white and also black left."
```
...
```json
Chatbot: "How can I help you today? Mr. Bond. For example, I can help you with your monthly payment, or check new balance."
```
...
```json
Chatbot: "Sorry, we do not offer Star Wars at this time. The only available showtime for Star Wars is 8:00pm and 10:00pm. Which time do you prefer?"
```
...
```json
Chatbot: "Ok, available Star Wars showtime is 8:00pm."
          // Tip: implicit confirmation for single entry inform.
         "Do you want to watch IMAX version? "
          // Tip: move onto next slot.
```
...
```json
Chatbot: "Sorry, we do not have available showtime for Star Wars. What else can I do for you?"
```
...
```json
Chatbot: "Sure, what kind of running shoes do you prefer? Do you need it for training or racing?"
User: "Training please."
Chatbot: "Running shoes for training, got it. Here are the running shoe series designed for training: Zoom Tempo NEXT%, ..."
```
