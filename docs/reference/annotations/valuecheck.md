...
## How To Use
Value Check is an optional slot annotation. When [Slot Filling](../../guide/slotfilling.md#five-stages-of-slot-filling) moves to Value Check, [Dialog Manager](../glossary.md#dialog-manager-dm) will check conditions defined in Value Check.
